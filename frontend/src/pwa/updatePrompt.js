...
export const applyPwaUpdate = async () => {
  ...
  emit()
  try {
    // vite-plugin-pwa envía SKIP_WAITING al worker que ya está esperando y
    // recarga cuando toma control. No borrar caches ni desregistrar el SW activo:
    // hacerlo aquí puede dejar el app shell sin sus chunks durante la transición.

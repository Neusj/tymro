...
from .views import (
    ...
    IndividualConsultationListCreateView,
    IndividualConsultationDateView,
    IndividualConsultationStartView,
    IndividualConsultationFinishView,
    MeView,
    StudentQrIdentityView,
    MembershipPlanViewSet,
    OrganizationViewSet,
    PasswordResetConfirmView,
    PasswordResetRequestView,
    PersonalizedClassSessionCancelView,
    PersonalizedClassQrView,
    PersonalizedClassSessionFinishView,
    PersonalizedClassSessionListView,
    PersonViewSet,
    PushPreferenceView,
    PushSubscriptionView,
    PublicInviteValidateView,
    PublicOrganizationSubdomainCheckView,
    PublicRegisterView,
    PublicTrialBookView,
...
urlpatterns = [
    ...
    path('me/student-qr/', StudentQrIdentityView.as_view()),
    ...
    path('public/organizations/check-subdomain/', PublicOrganizationSubdomainCheckView.as_view()),
    ...
    path('personalized-classes/', PersonalizedClassSessionListView.as_view()),
    path('personalized-classes/qr/', PersonalizedClassQrView.as_view()),
    path('personalized-classes/<int:pk>/cancel/', PersonalizedClassSessionCancelView.as_view()),
    path('personalized-classes/<int:pk>/finish/', PersonalizedClassSessionFinishView.as_view()),
    path('individual-consultations/', IndividualConsultationListCreateView.as_view()),
    path('individual-consultations/<int:pk>/agreed-date/', IndividualConsultationDateView.as_view()),
    path('individual-consultations/<int:pk>/start/', IndividualConsultationStartView.as_view()),
    path('individual-consultations/<int:pk>/finish/', IndividualConsultationFinishView.as_view()),
